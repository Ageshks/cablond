...
/**
 * WhatsAppButton – fixed, pulsing call-to-action that deep-links to a
 * pre-filled WhatsApp chat. Uses the official WhatsApp glyph (lucide-react
 * ships no brand icons), with a frosted tooltip that slides in on hover/focus.
 */
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      aria-label="Chat with Cablond on WhatsApp"
      title="Chat with Cablond on WhatsApp"
